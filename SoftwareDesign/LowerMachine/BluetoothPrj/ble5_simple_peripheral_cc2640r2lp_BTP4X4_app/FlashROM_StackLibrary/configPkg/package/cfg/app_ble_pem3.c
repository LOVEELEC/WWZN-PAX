 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ti/SoftwareDesign/LowerMachine/BluetoothPrj/ble5_simple_peripheral_cc2640r2lp_BTP4X4_app/FlashROM_StackLibrary/configPkg/package/cfg/app_ble_pem3");
