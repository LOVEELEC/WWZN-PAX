 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ti/WWZN-PAX/SoftwareDesign/LowerMachine/BluetoothPrj/ble5_simple_peripheral_hid_ManufacturerCustomEquipment_cc2640r2lp_app/FlashROM_StackLibrary/configPkg/package/cfg/app_ble_pem3");
