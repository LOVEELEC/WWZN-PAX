...
/*************** CS、RESET信号 ***************/
#define LCD_CS_HIGH()                   GPIO_SetBits(GPIOF, GPIO_Pin_7)
#define LCD_CS_LOW()                    GPIO_ResetBits(GPIOF, GPIO_Pin_7)

#define LCD_RST_HIGH()                  GPIO_SetBits(GPIOD, GPIO_Pin_8)
#define LCD_RST_LOW()                   GPIO_ResetBits(GPIOD, GPIO_Pin_8)
