...
__IO USB_OTG_TESTMODE_TypeDef _USBCORE_DATA_SECTION SET_TEST_MODE;

USBD_DCD_INT_cb_TypeDef USBD_DCD_INT_cb
_USBCORE_DATA_SECTION = 
{
    USBD_DataOutStage,
    USBD_DataInStage,
    USBD_SetupStage,
...
USBD_DCD_INT_cb_TypeDef *USBD_DCD_INT_fops _USBCORE_DATA_SECTION = &USBD_DCD_INT_cb;
/**
* @}
*/ 
