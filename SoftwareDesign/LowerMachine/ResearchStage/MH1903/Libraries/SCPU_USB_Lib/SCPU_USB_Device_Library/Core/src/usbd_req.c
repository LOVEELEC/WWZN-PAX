...
extern __IO USB_OTG_TESTMODE_TypeDef _USBCORE_DATA_SECTION SET_TEST_MODE;

__ALIGN_BEGIN uint32_t USBD_ep_status _USBCORE_DATA_SECTION __ALIGN_END  = 0; 
__ALIGN_BEGIN uint32_t  USBD_default_cfg _USBCORE_DATA_SECTION __ALIGN_END  = 0;
__ALIGN_BEGIN uint32_t  USBD_cfg_status _USBCORE_DATA_SECTION __ALIGN_END  = 0;  
__ALIGN_BEGIN uint8_t USBD_StrDesc[USB_MAX_STR_DESC_SIZ] _USBCORE_DATA_SECTION __ALIGN_END ;
/**
  * @}
  */ 
...
{
    static uint8_t cfgidx _USBCORE_DATA_SECTION;
