...
typedef enum{
    ...
    TRNG_PDSource_4 = 0x0010,
    TRNG_PDSource_5 = 0x0020,
    TRNG_PDSource_6 = 0x0040,
    TRNG_PDSource_7 = 0x0080
...
#define IS_TRNG_PDSource(PDSOURCE)  	    (((PDSOURCE) == TRNG_PDSource_0) ||\
                                             ...
                                             ((PDSOURCE) == TRNG_PDSource_4) ||\
                                             ((PDSOURCE) == TRNG_PDSource_5) ||\
                                             ((PDSOURCE) == TRNG_PDSource_6) ||\
                                             ((PDSOURCE) == TRNG_PDSource_7))
