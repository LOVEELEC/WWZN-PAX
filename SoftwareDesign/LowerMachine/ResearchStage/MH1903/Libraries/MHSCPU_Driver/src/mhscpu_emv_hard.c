...
#define __EMV_DATA_SECTION   __attribute__((section("emv_param"), zero_init))
#else
#define __EMV_DATA_SECTION
#endif
...
/* datas buffer */
volatile struct emv_queue  scs_queue[3] __EMV_DATA_SECTION;    
static volatile SCI_EMV_PARAM aEMV_Param[3] __EMV_DATA_SECTION;    
struct emv_core emv_devs[ EMV_TERMINAL_NUM ] __EMV_DATA_SECTION;
